...
void __wine_process_init(void)
{
    ...
    BOOL force_large_address_aware;
    INITIAL_TEB stack;
    ...
    force_large_address_aware = needs_override_large_address_aware(params->ImagePathName.Buffer);
    ...
    unix_funcs->server_init_process_done( kernel32_start_process, force_large_address_aware );
}
